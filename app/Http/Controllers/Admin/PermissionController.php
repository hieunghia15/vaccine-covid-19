...
class PermissionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.permissions.permission', compact('all_permissions_in_database'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route(('admin.permissions.index-permission'))->with('status', 'Tạo quyền hạn thành công');
    }
