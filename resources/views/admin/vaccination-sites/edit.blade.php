@extends('admin.layout-admin',[ 'title' => __($title ?? 'Cập nhật địa điểm tiêm chủng')])
@section('main')
                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Cập nhật địa điểm tiêm chủng</h3>
                                     ...
                                     <div class="tab-pane" id="address">
                                        <div class="row gy-4">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="location" class="form-control" placeholder="" value="{{$vaccination_sites->location}}">  
                                            </div>
                                            <div class="col-md-6">
